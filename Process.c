...
void Process_writeField(const Process* this, RichString* str, ProcessField field) {
   ...
   case NLWP:
      ...
      break;
   case PERCENT_CPU: Process_printPercentage(this->percent_cpu, buffer, n, Process_fieldWidths[PERCENT_CPU], &attr); 
   ...
   case PERCENT_MEM: Process_printPercentage(this->percent_mem, buffer, n, 4, &attr); 
